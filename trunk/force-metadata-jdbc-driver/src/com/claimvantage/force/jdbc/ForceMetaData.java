...
public class ForceMetaData implements DatabaseMetaData {
    ...
    public ForceMetaData(Connection connection) {
        this.connection = connection;
    }

    public String getDriverName() throws SQLException {
        return "ForceMetaDataDriver";
    }
    ...
    public ResultSet getTables(String catalog, String schemaPattern,
        ...
        return ((ForceConnection) connection).getResultSetFactory().getTables();
    }

    public ResultSet getColumns(String catalog, String schemaPattern,
            String tableNamePattern, String columnNamePattern)
            throws SQLException {
        return ((ForceConnection) connection).getResultSetFactory().getColumns(tableNamePattern);
    }
    
    public ResultSet getPrimaryKeys(String catalog, String schema, String table)
            throws SQLException {
        return ((ForceConnection) connection).getResultSetFactory().getPrimaryKeys(table);
    }

    public ResultSet getImportedKeys(String catalog, String schema, String table)
            throws SQLException {
        return ((ForceConnection) connection).getResultSetFactory().getImportedKeys(table);
    }
    
    public ResultSet getIndexInfo(String catalog, String schema, String table,
            boolean unique, boolean approximate) throws SQLException {
        return ((ForceConnection) connection).getResultSetFactory().getIndexInfo(table);
    }

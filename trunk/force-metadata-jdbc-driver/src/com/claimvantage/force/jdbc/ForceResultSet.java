...
public class ForceResultSet implements ResultSet {
    
    private int index = -1;
    private List<Map<String, Object>> maps;
    
    public ForceResultSet(List<Map<String, Object>> maps) {
        this.maps = maps;
    }

    public String getString(String columnName) throws SQLException {
        return (String) maps.get(index).get(columnName.toUpperCase());
    }

    public int getInt(String columnName) throws SQLException {
        Object o = maps.get(index).get(columnName.toUpperCase());
        return o != null ? (Integer) o : -1;
    }
    
    public short getShort(String columnName) throws SQLException {
        Object o = maps.get(index).get(columnName.toUpperCase());
        return o != null ? (Short) o : -1;
    }
